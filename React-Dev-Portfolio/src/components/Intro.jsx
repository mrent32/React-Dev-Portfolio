...
function Intro() {
  ...
  const projects = [
    { id: 1, title: 'Project 1', description: '', gitlink: 'https://github.com/mrent32', weblink: '', img: picOne },
  ...
  return (
    ...
    <card>
      <img src={portPic}></img>
    <h1 className="text-4xl md:text-7xl mb-1 md:mb-3 font=bold d-flex justify-content-center">Martin Renteria</h1>
    </card>
      <div className="d-flex flex-col md:flex-row items-center justify-space-around w-100 ">
        <div className="project-area w-100">
          {projects.map(({ title, id, description, gitlink, weblink, img }) => {
            return (
              <div id="portfolio" key={id} >
                <h3>{title}</h3>
                <a href={weblink}><img id="picone" src={picOne}></img></a>
      ...
      <Container fluid="md">
        <Row>
          <Col>As a dedicated software developer specializing in the MERN (MongoDB, Express.js, React, Node.js) stack,
            ...
            Clicking on the portfolio tab will redirect to showcase three of my proudest achievements in web development.
            ...
            and make meaningful contributions in the dynamic world of software development.</Col>
